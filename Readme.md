...
1. [Checkout](Checkout/checkout.md)
    ...
    * [IPN (instant payment notification)](Checkout/checkout.md#ipn)
    ...
    1. [Card tokenization](Checkout/createCardToken.md)
    1. [Check payment status](Checkout/checkTransactionStatus.md)
    1. [Merchant payment methods](Checkout/getMerchantPaymentMethods.md)
