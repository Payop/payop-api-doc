...
When you create a withdrawal request, you must transfer additional parameters for some withdrawal methods. Their structure and data depend on the selected method (all fields are required unless other is indicated).
